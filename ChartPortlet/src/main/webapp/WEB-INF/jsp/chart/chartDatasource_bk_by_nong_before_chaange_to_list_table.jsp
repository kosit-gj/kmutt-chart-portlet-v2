...
<!-- 
<script src="<c:url value="https://cdn.datatables.net/1.10.16/js/jquery.dataTables.min.js"/>"></script>
<link rel="stylesheet" href="<c:url value="https://cdn.datatables.net/1.10.16/css/jquery.dataTables.min.css"/>">
 -->
...
<script type="text/javascript">
	...
	var getObjectDatasourceListFn = function(){
		...
		var dataSourceListObject = $("#datasourceId option").get();
		var dataSourceList="";
	...
	$(document).ready(function(){
	    ...
	    $("select[name='tableDataSource_length']").css({"width":"60px","margin-bottom":"0px"});
	    $("input[type='search']").css({"width":"300px","margin-bottom":"0px"});
...
<body>
			...
			<table id='tableDataSource' class="table table-striped table-bordered" width="100%" cellspacing="0">
				...
				<tbody>
					<tr>
						...
						<a style='margin-left:3px;' class="btn btn-mini" href="#"><i class="icon-trash"></i> </a>
	...
	<form:form id="chartDatasource" style='display:none;' modelAttribute="chartDatasourceForm" method="post" name="chartDatasourceForm" action="${formAction}" enctype="multipart/form-data">
