...
public class MultiSeries2DSingleYCombination extends CommonChart implements Chart {
	private static final Logger logger = Logger.getLogger(ServiceConstant.LOG_APPENDER);
	
	List<Object[]> data;
	public MultiSeries2DSingleYCombination(){
		super("MultiSeries2DSingleYCombination");  
	}
	@Override
