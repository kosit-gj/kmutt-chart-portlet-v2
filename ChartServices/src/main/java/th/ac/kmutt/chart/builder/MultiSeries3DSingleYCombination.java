...
public class MultiSeries3DSingleYCombination extends CommonChart implements Chart {
	private static final Logger logger = Logger.getLogger(ServiceConstant.LOG_APPENDER);
	
	List<Object[]> data;
	public MultiSeries3DSingleYCombination(){
		super("MultiSeries3DSingleYCombination");  
	}
	@Override
